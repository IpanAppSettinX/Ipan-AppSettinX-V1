...
const fallbackAdvancedTweaks = [
  ...
  { tweak_id: "adv.debloat_windows", number: 22, title: "Debloat Windows", category: "Gaming", safety: "caution", summary: "Hapus aplikasi bawaan tidak perlu.", technical_effect: "Remove AppX bloatware via PackageManager (native).", warning: "Beberapa app tidak bisa diinstal ulang." },
